#!/usr/bin/env bash
# Register sub-NDRI240907329299 acq-S1 (sacral, S2-S3) to PAM50 — PAM50 space
#
...
#
# Launch: set_slot 2-3 bash scripts/register_sub-NDRI240907329299_acq-S1_pam50_space_registration.sh
