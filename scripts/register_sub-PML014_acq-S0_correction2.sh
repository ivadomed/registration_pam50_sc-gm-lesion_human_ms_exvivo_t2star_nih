#!/usr/bin/env bash
# Register sub-PML014 acq-S0 (cervical, C1-C2) to PAM50 — correction 2
#
...
#
# Launch: set_slot 2-3 bash scripts/register_sub-PML014_acq-S0_correction2.sh
...
OUT="${SCRIPT_DIR}/results/correction_2/${SUBJ}_acq-${ACQ}"
...
echo ""
echo "=== Step 5: Register to PAM50 (native 0.075mm space) ==="
