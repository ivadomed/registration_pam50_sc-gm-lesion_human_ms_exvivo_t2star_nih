#!/usr/bin/env bash
# Register sub-PML014 acq-S0 (cervical, C1-C2) to PAM50 — native space
#
...
#
# Launch: set_slot 2-3 bash scripts/register_sub-PML014_acq-S0_native_space_registration.sh
