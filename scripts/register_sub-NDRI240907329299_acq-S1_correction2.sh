#!/usr/bin/env bash
# Register sub-NDRI240907329299 acq-S1 (sacral, S2-S3) to PAM50 — correction 2
#
...
#
# Launch: set_slot 2-3 bash scripts/register_sub-NDRI240907329299_acq-S1_correction2.sh
